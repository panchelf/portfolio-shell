...
function generateTeam(players, teamName) {
    ...
    players.forEach(p => {
        ...
        circle.addEventListener('mouseenter', (e) => {
            ...
            // card.style.top = `${rect.top + window.scrollY - 50}px`;
            card.style.top = `${rect.top - 50}px`;
    
            // document.querySelector('#card-portrait').src = `https://ui-avatars.com/api/?name=${encodeURIComponent(p.shortname)}&background=random`;
